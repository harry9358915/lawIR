    ...
    def __init__(
        ...
        if self._mode == 'train':
            ...
            for task_id in subdirs:
                ...
                with open(traindataset+ "/" + task_id+ "/clean_base_case.txt", mode="r", encoding="utf-8") as file:
            ...
            for task_id in subdirs:
                ...
                with open(devdataset+ "/"+ task_id+ "/clean_base_case.txt", mode="r", encoding="utf-8") as file:
                    for line in file.readlines():
                        self._queries[task_id] = line
                        print(task_id)
                        break
            ...
            for task_id in subdirs:
                ...
                with open(testdataset+"/"+ task_id+ "/clean_base_case.txt", mode="r", encoding="utf-8") as file:
                    for line in file.readlines():
                        self._queries[task_id] = line
                for candidatesfile in candidates_list:
